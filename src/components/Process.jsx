...
const steps = [
  {
    number: '01',
    title: 'קטיף יד מוקדם',
    desc: 'רק העלים הכי צעירים, נקטפים ביד מוקדם בבוקר.',
  },
  {
    number: '02',
    title: 'אידוי מיידי',
    desc: 'מאדים את העלים מיד אחרי הקטיף, כדי שהצבע והטעם יישארו.',
  },
  {
    number: '03',
    title: 'אריזה בוואקום',
    desc: 'האבקה נארזת בלי אוויר ובלי אור, מיד אחרי הטחינה.',
  },
  {
    number: '04',
    title: 'ישר אליכם',
    desc: 'בלי מחסנים באמצע. תאריך הקטיף מודפס על כל אריזה, כדי שתדעו כמה זה טרי.',
  },
]
